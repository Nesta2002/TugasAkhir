...
<html lang="en" dir="ltr">
  ...
  div.header{
    width: 100%;
    height: 500px;
    background-image: url("eduwood3.jpg");
  ...
  <body>
    ...
    <div class="tentang">
      <div class="left">
        ...
        <p>
          Jonathan-Di education pengajarnya sangat menyenangkan dan ramah. Penjelasannya mudah dimengerti dan dipahami.
        </p>
      </div>
      <div class="right">
        <img src="prestasi1.jpg" />
      </div>
    </div>

    <div class="tentangkanan">
      <div class="right">
        <h1>
          Mengapa
          <br>
        ...
        <p>
          Elina-Sangat membantu sekali dalam belajar. Kami juga diajarkan rumus-rumus cepat yang membantu pengerjaan soal menjadi lebih cepat.
        </p>
      </div>
      <div class="left">
        <img src="prestasi2.jpg" />
      </div>
    </div>
    ...
    <div class="tentang">
      <div class="left">
        ...
        <p>
          Evelyn-Setelah sekian lama saya menemukan bimbel yang sangat nyaman. Saya tidak menemukan bimbel yang senyaman ini sebelum saya bera.
        </p>
      </div>
      <div class="right">
        <img src="prestasi3.jpg" />
      </div>
    </div>
  </body>
</html>
